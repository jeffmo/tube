...
impl Tube {
    // !!!!! TODO: After moving Tube to tubez_common, we can no longer hide Tube::new()
    //             with visibility specifications :(
    //
    //             One clean way to fix this up is probably to switch from a 
    //             "workspace" to a crate with "client" and "server" feature 
    //             flags. One single crate with src/{client, common, server}/ 
    //             sub-dirs.
    pub(in crate) fn new(
        tube_owner: TubeOwner,
        tube_id: u16,
